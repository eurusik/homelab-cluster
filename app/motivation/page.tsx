  ...
  return (
    <div className="flex max-w-7xl mx-auto">
      ...
      <div className="flex-1 px-8 py-12 max-w-4xl">
        ...
        <h1 className="text-5xl font-bold mb-8 text-white font-mono">Motivation</h1>
        
        <p className="text-xl text-gray-400 mb-12 font-mono">
          This is what i need from my homelab (evolution from Dell PowerEdge)
        </p>
        ...
        <div className="space-y-12">
          <section id="key-premisses">
            ...
            <ol className="space-y-6 list-decimal list-inside text-gray-300 font-mono">
              ...
              <li className="leading-relaxed">
                <span className="font-bold text-white">Portability & Efficiency:</span> Moved from Dell PowerEdge to Raspberry Pi cluster for lower power consumption and better portability.
              </li>
              <li className="leading-relaxed">
            ...
            <InfoBlock>
              This is not my first homelab—I previously ran a Dell PowerEdge server. However, I'm transitioning to a Raspberry Pi cluster for better energy efficiency, quieter operation, and more flexibility in experimenting with distributed systems.
            </InfoBlock>
          </section>
          ...
          <section id="purpose">
            ...
            <p className="text-gray-300 font-mono leading-relaxed mb-6">
              Having experience with Dell PowerEdge servers, I wanted a more efficient and quieter solution that still provides enterprise-level capabilities. The Raspberry Pi cluster offers the perfect balance between cost, power consumption, and learning opportunities for cloud-native technologies.
            </p>
