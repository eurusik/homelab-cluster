  ...
  return (
    ...
    >
        ...
        <div className="space-y-8 sm:space-y-12">
          {/* Intro */}
          <section id="intro">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6 text-white font-mono">Intro</h2>
            <p className="text-sm sm:text-base text-gray-400 mb-3 sm:mb-4 font-mono break-words">
          ...
          <section id="prerequisites">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6 text-white font-mono">Prerequisites</h2>
            <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6 font-mono">
              This guide assumes that:
            </p>
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-300 font-mono mb-4 sm:mb-6 space-y-2 break-words">
          ...
          <section id="server-node">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6 text-white font-mono">Setup the Server Node</h2>
            <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6 font-mono break-words">
            ...
            <TimelineGroup>
              <TimelineStep stepNumber={1} title="Connect to your Server Node via SSH">
                <p className="text-sm sm:text-base text-gray-400 font-mono mb-3 sm:mb-4 break-words">
                  Open the terminal and connect to your server node (RpiMaster) using:
                </p>
                <CodeBlock code="ssh <username>@192.168.88.5" />
                <p className="text-sm sm:text-base text-gray-400 font-mono mt-3 sm:mt-4 break-words">
                  Replace <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm">&lt;username&gt;</code> with the username you configured during Raspberry Pi setup.
                </p>
              </TimelineStep>
              ...
              <TimelineStep stepNumber={2} title="Install K3s">
                ...
                <p className="text-sm sm:text-base text-gray-400 font-mono mt-3 sm:mt-4">
                  The installation script will:
                </p>
                <ul className="list-disc list-inside text-sm sm:text-base text-gray-300 font-mono space-y-2 ml-4 mt-2 break-words">
              ...
              <TimelineStep stepNumber={3} title="Get Server Token">
                ...
                <p className="text-sm sm:text-base text-gray-400 font-mono mt-3 sm:mt-4 break-words">
                  The output will be a long string like <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm break-all">K10a1b2c3d4e5f6...</code>
                </p>
                <div className="mt-3 sm:mt-4">
                  <InfoBlock>
          ...
          <section id="agent-nodes">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6 text-white font-mono">Setup the Agent Nodes</h2>
            <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6 font-mono break-words">
            ...
            <div className="mt-4 sm:mt-6">
              <TimelineGroup>
                <TimelineStep stepNumber={1} title="Connect to your Agent Node via SSH">
                  ...
                  <p className="text-sm sm:text-base text-gray-400 font-mono mt-3 sm:mt-4 break-words">
                    For the second worker node, use <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm break-all">192.168.88.7</code> instead.
                  </p>
                </TimelineStep>
                ...
                <TimelineStep stepNumber={2} title="Install K3s as Agent">
                  ...
                  <ul className="list-disc list-inside text-sm sm:text-base text-gray-300 font-mono space-y-2 ml-4 mb-3 sm:mb-4 break-words">
                    <li>The server node IP address: <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm break-all">192.168.88.5</code></li>
                  ...
                  <p className="text-sm sm:text-base text-gray-400 font-mono mt-3 sm:mt-4 break-words">
                    Replace <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm break-all">&lt;server_node_token&gt;</code> with the actual token you saved earlier.
                  </p>
                  <div className="mt-3 sm:mt-4">
                    <InfoBlock>
                      This command tells K3s to install in agent mode and connect to the server at <span className="font-bold break-all">192.168.88.5:6443</span> using the provided token for authentication.
                    </InfoBlock>
                  </div>
                </TimelineStep>
              </TimelineGroup>
            ...
            <p className="text-sm sm:text-base text-gray-400 font-mono mt-6 sm:mt-8">
          ...
          {/* Verify Cluster */}
          <section id="verify">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6 text-white font-mono">Verify Your Cluster</h2>
            <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6 font-mono break-words">
            ...
            <TimelineGroup>
              ...
              <TimelineStep stepNumber={2} title="Check Cluster Nodes">
                ...
                <p className="text-sm sm:text-base text-gray-400 font-mono mt-3 sm:mt-4 mb-3 sm:mb-4">
                  Expected output:
                </p>
                <OutputBlock output={`NAME         STATUS   ROLES                  AGE   VERSION
rpimaster    Ready    control-plane,master   5m    v1.28.3+k3s1
rpiworker1   Ready    <none>                 3m    v1.28.3+k3s1
rpiworker2   Ready    <none>                 2m    v1.28.3+k3s1`} />
                <p className="text-sm sm:text-base text-gray-400 font-mono mt-3 sm:mt-4 break-words">
                  All nodes should show <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm">Ready</code> status. If a node shows <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm">NotReady</code>, wait a minute and check again—it may still be initializing.
                </p>
              </TimelineStep>
              ...
              <TimelineStep stepNumber={3} title="Verify System Pods">
                ...
                <p className="text-sm sm:text-base text-gray-400 font-mono mt-3 sm:mt-4 break-words">
                  You should see pods for core services like <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm">coredns</code>, <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm">metrics-server</code>, and <code className="bg-[#1a1a1a] px-2 py-1 rounded text-[#ff8c00] text-xs sm:text-sm">traefik</code> in Running state.
                </p>
              </TimelineStep>
            </TimelineGroup>
          </section>
